...
function Header (){
    ...
    return (
        <Nav  style={{"background":headerBackground}}>
            <Col>
                <Logo
                    variants={logoVar}
                    initial="nomal"
                ...
                <Items>
                    <Item>
                        <Link to="/">
                            홈 { homeMatch && <Circle layoutId="circle"></Circle>}
                        </Link>
                    </Item>
            ...
            <Col>
            <Search>
                <motion.svg onClick={openSearch}
                    animate={{x : searchOpen ? -225 : 0}}
                    transition={{type:"liner"}}
                    fill={`${searchOpen ? "#000" : "#fff"}`}
                    viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg"
                >
                    <path
                ...
                <Form onSubmit={onValid}>
                    ...
                    placeholder="영화나 TV쇼를 검색해보세요..."></Input>    
                </Form>
            </Search>
            </Col>
        </Nav>
